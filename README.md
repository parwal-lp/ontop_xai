...
- `domains/` contains one subfolder per domain, containing configurations and resources, used to speed up subsequent runs on the same domain (e.g. `domains/books/abox.nt`).
